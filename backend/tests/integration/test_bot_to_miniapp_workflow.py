...
class TestBotToMiniAppWorkflow:
    ...
    def _setup_mocks(self):
        ...
        # API service mocks
        mock_presign = patch(
            "calorie_track_ai_bot.services.storage.tigris_presign_put",
        ...
        mock_resolve_user = patch(
            "calorie_track_ai_bot.services.db.resolve_user_id",
            new_callable=AsyncMock,
            return_value="user-uuid-123",
        )
        mock_get_summary = patch(
        ...
        mock_get_photo = patch("calorie_track_ai_bot.workers.estimate_worker.db_get_photo")
        ...
        return {
            ...
            "resolve_user": started_patches[14],  # mock_resolve_user
            "get_summary": started_patches[15],  # mock_get_summary
            "s3": started_patches[16],  # mock_s3
            "estimate": started_patches[17],  # mock_estimate
            "save_estimate": started_patches[18],  # mock_save_estimate
            "get_photo": started_patches[19],  # mock_get_photo
            "patches": all_patches,
        }

    def test_complete_bot_to_miniapp_workflow(self, client):
    ...
    def test_bot_to_miniapp_workflow_with_multiple_meals(self, client):
    ...
    def test_bot_to_miniapp_workflow_empty_day(self, client):
    ...
    def test_bot_to_miniapp_workflow_authentication_flow(self, client):
    ...
    def test_bot_to_miniapp_workflow_data_consistency(self, client):
